...
def ingest_daily(request):
    """Triggered daily by Cloud Scheduler (Diagram 2).
    Archives raw JSON and loads the partitioned BigQuery raw table that
    feeds the curated view for reporting/auditing.
    """
    api_key = get_secret()
